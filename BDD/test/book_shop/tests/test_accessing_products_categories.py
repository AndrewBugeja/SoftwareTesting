...
class TestProductCategories:
    ...
    def test_products_categories_access_functionality(self, get_driver, category_name, num_products):
        ...
        categories_page.click_on_a_category("Signed")
        assert categories_page.verify_category_is_loaded("Signed"), "Category not loaded"
        assert categories_page.verify_categories_has_at_least_n_number_of_products("2"), "n Products not found"
